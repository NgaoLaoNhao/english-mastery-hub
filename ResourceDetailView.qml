...
Item {
    ...
    property var resource: null         // MockResourceController
    ...
    // ===== M7 D.3: User context + like state =====
    ...
    // Counter để re-evaluate khi like / comment thay đổi
    ...
    ColumnLayout {
        ...
        ScrollView {
            ...
            ColumnLayout {
                ...
                // ===== M7 D.3 — Card 1: URL / Link tài liệu =====
                Rectangle {
                    visible: !!info
                    Layout.fillWidth: true
                    Layout.leftMargin: 20; Layout.rightMargin: 20
